...
Details on the application can be found [in the rag-nodejs/README.md](../README.md). By default, this Containerfile includes a model-server
...
The rag-nodejs can be accessed by visiting port `8150` of the running bootc system.
...
```bash
podman kube play /usr/share/containers/systemd/rag-nodejs.yaml
```
